...
// [[Rcpp::export]]
RawVector fetch(CharacterVector server, CharacterVector method, RawVector requestArg, CharacterVector metadata, int n) {
  
  gpr_timespec deadline = n_seconds_from_now(n);
